...
public class MySettingController {
    ...
    public String mySetting(@PathVariable("user_id") Integer user_id, Model model)
    {
    ...
    public String updatePersonMsg(@RequestParam("user_id") Integer user_id,@RequestParam("user_name") String user_name,
